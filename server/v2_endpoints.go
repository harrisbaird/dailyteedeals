...
func V2DealsEndpoint(db orm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.AbortWithStatusJSON(http.StatusNotFound, gin.H{"error": "deals not found", "string": err.Error()})
			return
		}
...
func V2DesignEndpoint(db orm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.AbortWithStatusJSON(http.StatusNotFound, gin.H{"error": "design not found", "string": err.Error()})
			return
		}
...
func V2ArtistEndpoint(db orm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.AbortWithStatusJSON(http.StatusNotFound, gin.H{"error": "artist not found", "string": err.Error()})
			return
		}
...
func V2SiteIndexEndpoint(db orm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.AbortWithStatusJSON(http.StatusNotFound, gin.H{"error": "sites not found", "string": err.Error()})
			return
		}
...
func V2SiteShowEndpoint(db orm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.AbortWithStatusJSON(http.StatusNotFound, gin.H{"error": "site not found", "string": err.Error()})
			return
		}
